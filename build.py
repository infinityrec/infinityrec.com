...
def base_html(title, desc, keywords_list, body_html, depth="", schema_json=""):
...
<head>
  ...
  <link rel="canonical" href="https://infinityrec.com/{title.lower().replace(' ','-')}.html">
...
def aggregate_rating_schema():
    return {
        ...
        "description": "Premium IPTV subscription with 15,000+ channels in 4K for USA, UK & Canada.",
...
def copy_template_page(page_filename, config, faq_data, output_dir):
    ...
    final_html = base_html(title, desc, kws, body_content, depth="", schema_json=schema_tag)
...
<div class="container section">
  ...
  <p>{blog_links} | <a href="../pillar.html">Ultimate IPTV Guide 2026</a></p>
    ...
    html = base_html(title, desc, kws, body, depth="../", schema_json=schemas)
...
<div class="container section">
  ...
  <div class="card">
    ...
    html = base_html(title, desc, kws, body, depth="", schema_json=schemas_tag(*schema_list))
